...
def is_valid_word(word, hand, word_list):
    ...
    if word not in word_list:
        ...
        for potential_word in wildcard_words:
    ...
    while temp_bool == True:
        for i in word:
            if i not in temp_hand or temp_hand[i] == 0:
                return False
            temp_hand[i] -= 1
        break
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while calculate_handlen(hand) > 0:
        ...
        display_hand(hand)
        # Ask user for input
        word=input('Please enter a word (or enter !! to end game): ')
        ...
        # Otherwise (the input is not two exclamation points):
            ...
            # If the word is valid:
                ...
                print('"'+word+'" earned', word_score, 'points. Total:', current_score)
...
def substitute_hand(hand, letter):
    ...
    if letter in substitute_hand:
        ...
        while new_letter in substitute_hand:
            new_letter=random.choice(VOWELS+CONSONANTS)

        substitute_hand[new_letter]=substitute_hand[letter]
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    total_score=0
    replay=0
    number_of_hands=int(input("How many hands do you want to play? "))
    ...
    while number_of_hands > 0:
        ...
        substitute=input("Would you like to replace one of the letters with another? ")
        if substitute.lower() == 'yes':
            replaced_letter=input("Which letter would you like replaced? ")
